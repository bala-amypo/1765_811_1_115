// File: src/main/java/com/example/demo/repository/TemperatureRuleRepository.java
...
public interface TemperatureRuleRepository extends JpaRepository<TemperatureRule, Long> {
    ...
    // Must use @Query per requirements
    @Query("SELECT r FROM TemperatureRule r " +
           "WHERE r.productType = :productType AND r.active = TRUE " +
